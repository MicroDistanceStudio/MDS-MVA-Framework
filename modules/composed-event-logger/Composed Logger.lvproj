...
<Project Type="Project" LVVersion="19008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Examples" Type="Folder">
			<Item Name="Logger Examples.lvlib" Type="Library" URL="../Examples/Logger Examples.lvlib"/>
		</Item>
		<Item Name="Extensions" Type="Folder">
			<Item Name="Abstractions" Type="Folder">
				<Item Name="IStringFormat.lvclass" Type="LVClass" URL="../Source/IStringFormat/IStringFormat.lvclass"/>
				<Item Name="String Log Sink.lvclass" Type="LVClass" URL="../Source/String Log Sink/String Log Sink.lvclass"/>
			</Item>
			<Item Name="Filters" Type="Folder">
				<Item Name="Compound Filter.lvclass" Type="LVClass" URL="../Source/Filters/Compound Filter/Compound Filter.lvclass"/>
				<Item Name="Event Keyword Filter.lvclass" Type="LVClass" URL="../Source/Filters/Event Keyword Filter/Event Keyword Filter.lvclass"/>
				<Item Name="Event Level Filter.lvclass" Type="LVClass" URL="../Source/Filters/Event Level Filter/Event Level Filter.lvclass"/>
				<Item Name="Event Source Filter.lvclass" Type="LVClass" URL="../Source/Filters/Event Source Filter/Event Source Filter.lvclass"/>
			</Item>
			<Item Name="String Formats" Type="Folder">
				<Item Name="String Expression Format.lvclass" Type="LVClass" URL="../Source/String Formats/String Expression Format/String Expression Format.lvclass"/>
			</Item>
			<Item Name="Text File" Type="Folder">
				<Item Name="Text File.lvclass" Type="LVClass" URL="../Source/Text File Sink/Text File/Text File.lvclass"/>
				<Item Name="Text File Sink.lvclass" Type="LVClass" URL="../Source/Text File Sink/Text File Sink.lvclass"/>
			</Item>
			<Item Name="LVQueue Sink.lvclass" Type="LVClass" URL="../Source/LVQueue Sink/LVQueue Sink.lvclass"/>
			<Item Name="String Control Sink.lvclass" Type="LVClass" URL="../Source/String Control Sink/String Control Sink.lvclass"/>
			<Item Name="SystemLog Sink.lvclass" Type="LVClass" URL="../Source/SystemLog Sink/SystemLog Sink.lvclass"/>
			<Item Name="ConsoleView.lvlib" Type="Library" URL="../Source/ConsoleView/ConsoleView.lvlib"/>
			<Item Name="Buffered Log Sink.lvclass" Type="LVClass" URL="../Source/Buffered Log Sink/Buffered Log Sink.lvclass"/>
			<Item Name="Buffered String Log Sink.lvclass" Type="LVClass" URL="../Source/Buffered String Log Sink/Buffered String Log Sink.lvclass"/>
		</Item>
		<Item Name="Test" Type="Folder">
			<Item Name="Benchmarking" Type="Folder">
				<Item Name="Benchmarking.lvclass" Type="LVClass" URL="../Test/Benchmarking/Benchmarking.lvclass"/>
			</Item>
			<Item Name="TestAggregateLog" Type="Folder">
				<Item Name="TestAggregateLog.lvclass" Type="LVClass" URL="../Test/TestAggregateLog/TestAggregateLog.lvclass"/>
			</Item>
			<Item Name="TestComposedLog" Type="Folder">
				<Item Name="TestComposedLog.lvclass" Type="LVClass" URL="../Test/TestComposedLog/TestComposedLog.lvclass"/>
			</Item>
			<Item Name="TestDataSink" Type="Folder">
				<Item Name="TestDataSink.lvclass" Type="LVClass" URL="../Test/TestDataSink/TestDataSink.lvclass"/>
			</Item>
			<Item Name="TestLocalLogInstance" Type="Folder">
				<Item Name="TestLocalLogInstance.lvclass" Type="LVClass" URL="../Test/TestLocalLogInstance/TestLocalLogInstance.lvclass"/>
			</Item>
			<Item Name="TestMalleableInterface" Type="Folder">
				<Item Name="TestMalleableInterface.lvclass" Type="LVClass" URL="../Test/TestMalleableInterface/TestMalleableInterface.lvclass"/>
			</Item>
			<Item Name="TestTextFileSink" Type="Folder">
				<Item Name="TestTextFileSink.lvclass" Type="LVClass" URL="../Test/TestTextFileSink/TestTextFileSink.lvclass"/>
			</Item>
			<Item Name="TestLogValue.lvclass" Type="LVClass" URL="../Test/TestLogValue/TestLogValue.lvclass"/>
			<Item Name="TestLogFilter.lvclass" Type="LVClass" URL="../Test/TestLogFilter/TestLogFilter.lvclass"/>
			<Item Name="TestBufferedLogSink.lvclass" Type="LVClass" URL="../Test/TestBufferedLogSink/TestBufferedLogSink.lvclass"/>
			<Item Name="TestStringControlSink.lvclass" Type="LVClass" URL="../Test/TestStringControlSink/TestStringControlSink.lvclass"/>
		</Item>
		<Item Name="Composed Log.lvlib" Type="Library" URL="../Source/Composed Log/Composed Log.lvlib"/>
		<Item Name="Singleton Event Log.lvlib" Type="Library" URL="../Source/Composed Log/Singleton Event Log/Singleton Event Log.lvlib"/>
