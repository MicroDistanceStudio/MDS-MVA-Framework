...
<Project Type="Project" LVVersion="20008000">
	<Property Name="CCSymbols" Type="Str">ENABLE_VERBOSE_LOG,False;REMOVE_FRAMEWORK_LOG,False;</Property>
	...
	<Item Name="My Computer" Type="My Computer">
			...
			<Item Name="@cs" Type="Folder">
				...
				<Item Name="event-logger" Type="Folder">
					<Item Name="Examples" Type="Folder">
						<Item Name="Logger Examples.lvlib" Type="Library" URL="../modules/composed-event-logger/Examples/Logger Examples.lvlib"/>
					</Item>
					<Item Name="Source" Type="Folder">
		...
		<Item Name="Test" Type="Folder">
			<Item Name="Automated" Type="Folder">
				<Item Name="TestActorEvents.lvclass" Type="LVClass" URL="../Test/Automated/TestActorEvents/TestActorEvents.lvclass"/>
				<Item Name="TestIViewModel.lvclass" Type="LVClass" URL="../Test/Automated/TestIViewModel/TestIViewModel.lvclass"/>
				...
				<Item Name="TestPubSubRouting.lvclass" Type="LVClass" URL="../Test/Automated/TestPubSubRouting/TestPubSubRouting.lvclass"/>
			</Item>
			<Item Name="Doubles" Type="Folder">
				<Item Name="TestActorEvents" Type="Folder">
					<Item Name="ViewableListboxBadReg.lvclass" Type="LVClass" URL="../Test/Doubles/ViewableListboxBadReg/ViewableListboxBadReg.lvclass"/>
					<Item Name="ViewableMCListboxBadReg.lvclass" Type="LVClass" URL="../Test/Doubles/ViewableMCListboxBadReg/ViewableMCListboxBadReg.lvclass"/>
					<Item Name="ViewableTreeBadReg.lvclass" Type="LVClass" URL="../Test/Doubles/ViewableTreeBadReg/ViewableTreeBadReg.lvclass"/>
				</Item>
				<Item Name="TestProtectedSubpanel" Type="Folder">
					<Item Name="ViewableOne.lvclass" Type="LVClass" URL="../Test/Doubles/ViewableOne/ViewableOne.lvclass"/>
					<Item Name="ViewableTwo.lvclass" Type="LVClass" URL="../Test/Doubles/ViewableTwo/ViewableTwo.lvclass"/>
				</Item>
				<Item Name="TestPubSubRouting" Type="Folder">
					<Item Name="ObservingModel.lvclass" Type="LVClass" URL="../Test/Doubles/ObservingModel/ObservingModel.lvclass"/>
					<Item Name="ObservingViewable.lvclass" Type="LVClass" URL="../Test/Doubles/ObservingViewable/ObservingViewable.lvclass"/>
					<Item Name="ObservingViewModel.lvclass" Type="LVClass" URL="../Test/Doubles/ObservingViewModel/ObservingViewModel.lvclass"/>
					<Item Name="PublishingModel.lvclass" Type="LVClass" URL="../Test/Doubles/PublishingModel/PublishingModel.lvclass"/>
					<Item Name="PublishingViewable.lvclass" Type="LVClass" URL="../Test/Doubles/PublishingViewable/PublishingViewable.lvclass"/>
					<Item Name="PublishingViewModel.lvclass" Type="LVClass" URL="../Test/Doubles/PublishingViewModel/PublishingViewModel.lvclass"/>
				</Item>
				<Item Name="LeakyViewable.lvlib" Type="Library" URL="../Test/Doubles/LeakyViewable.lvlib"/>
			</Item>
			<Item Name="Performance" Type="Folder">
				<Item Name="TestFrameworkPerformance.lvlib" Type="Library" URL="../Test/Performance Test/TestFrameworkPerformance.lvlib"/>
			</Item>
		</Item>
		<Item Name="ActorEvents.lvlib" Type="Library" URL="../Source/ActorEvents/ActorEvents.lvlib"/>
		<Item Name="IViewable.lvlib" Type="Library" URL="../Source/IViewable/IViewable.lvlib"/>
		<Item Name="IViewManager.lvlib" Type="Library" URL="../Source/IViewManager/IViewManager.lvlib"/>
		<Item Name="IViewModel.lvlib" Type="Library" URL="../Source/IViewModel/IViewModel.lvlib"/>
